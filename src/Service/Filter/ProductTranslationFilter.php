...
class ProductTranslationFilter extends AbstractFilter
{
    ...
    {
        return [
            FilterEnum::PRODUCT_PROPERTY->value => [
                'property' => FilterEnum::PRODUCT_PROPERTY->value,
                'type' => 'string',
                'required' => false,
                'swagger' => ['description' => 'Search product translation by product'],
            ],
            FilterEnum::LANGUAGE_PROPERTY->value => [
                'property' => FilterEnum::LANGUAGE_PROPERTY->value,
                'type' => 'string',
                'required' => false,
                'swagger' => ['description' => 'Search product translation by language'],
            ],
        ];
    }
    ...
    {
        return [
            FilterEnum::PRODUCT_PROPERTY->value => FilterEnum::PRODUCT_PROPERTY->value,
        ];
    }
